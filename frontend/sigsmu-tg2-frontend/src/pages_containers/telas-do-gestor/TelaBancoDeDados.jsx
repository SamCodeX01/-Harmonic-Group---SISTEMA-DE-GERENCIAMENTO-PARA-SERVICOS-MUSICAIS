...
import HelpDoGestor from "../../components/_maiores/gestor/cadastronobd/HelpDoGestor"
        ...
        <div className={styles.main}>
            ...
            <div className={styles.botoes}>
                <Radio selecionado={operacao} setSelecionado={setOperacao} name={"crud"} grupo={2} >
                    <BotaoSimples msg={"CADASTRAR"} rota={""} estilo={true} />
                    <BotaoSimples msg={"ALTERAR"} rota={""} estilo={true} />
                    <BotaoSimples msg={"EXCLUIR"} rota={""} estilo={true} />
                </Radio>
            </div>
                    ...
                    >
                        {
                            ...
                            Object.entries(moldeBanco).map(([nome, valor]) => {
                                ...
                                return (tabelaSelecionada != valor[1] ? <BotaoSimples msg={nome} /> : <></>)
                            })
            ...
            <div className={styles.tabelaCampos} >
                <div>
                    ...
                    {
                        Object.entries(moldeBanco).map(([nome, valor]) => {
                            return (tabelaSelecionada !== null && tabelaSelecionada === valor[1] ? <BotaoSimples msg={nome}/> : "")
                        })
                    }
                    </div>
                    ...
                    <div className={styles.campos}>
                    {
                        (tabelaSelecionada !== null &&
                            valoresRadio.split(",").map(campo => {
                                return <BotaoSimples msg={campo[3] !== "_" ? campo : ""} />
