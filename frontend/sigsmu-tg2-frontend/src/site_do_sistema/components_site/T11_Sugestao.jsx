    ...
    <div>            
        ...
        <div className={t11_sugestaoCss.tituloContainer}>
            ...
            <div className={t11_sugestaoCss.eventosContainer}>
                ...
                <EventoItem evento={cerimoniaReligiosa}/>
                <EventoItem evento={festaAniversario}/>
                <EventoItem evento={festaFormatura}/>
                <EventoItem evento={eventoCorporativo}/>
            </div>
